...
export default function Navbar() {
  return (
    <div className="flex items-center justify-between w-full md:pl-10">
      <span className="flex items-center py-2 justify-center md:justify-start">
        <img
          className="w-14 h-14"
          alt="Logo"
        ...
        {/* <h1 className="py-4  md:hidden inline-flex items-center text-xl md:text-2xl font-semibold text-violet-500 gap-2">
          <span className="scale-90 mt-1 text-violet-500 text- py-2 rounded-full"> SanTech API Client</span>{' '}
        </h1> */}
      </span>
      <span className="flex items-center justify-center md:justify-start">
        <a href="https://santechapihubs.vercel.app/dashboard/home" className="">
